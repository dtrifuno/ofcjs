        ...
        <div className="menu-body">
          ...
          <form>
            <div className="form-container">
              ...
              <div>
                <button onClick={e => this.onJoin(e)}>Join Game</button>
                <button onClick={e => this.onStart(e)}>Start Game</button>
              </div>
            </div>
          </form>

          <p> Alternatively, you can play a game against an AI opponent.</p>
          <button>Play Against AI</button>

          <p>
            To learn more about the rules of open-faced Chinese poker or the
            scoring system used by OFC.js, click <a href="#">here</a>.
          </p>
        </div>
      </div>
    );
